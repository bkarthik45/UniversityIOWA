...
closeModal() {
  ...
  onSubmit(form: NgForm): void {
    // Step 1: Mark all form controls as touched to trigger inline validation
    if (form.invalid) {
    ...
    // Step 2: Business rule check – Purchase date should not be in the future
    ...
    // Step 4: Build and submit FormData
